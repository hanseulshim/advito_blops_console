...
//DUMMY DATA
import { hotelSummary } from 'data/hotelData/hotelSummary';
import { hotelSpend } from 'data/hotelData/hotelSpend';
import { topHotelChains } from 'data/hotelData/topHotelChains';
...
//COMPONENT
class HotelStory extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dataFormat: 'integer',
      viewIndex: 0,
      data: [hotelSummary, hotelSpend, topHotelChains],
    };
  }
