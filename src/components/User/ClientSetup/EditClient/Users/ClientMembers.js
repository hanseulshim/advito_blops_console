...
class ClientMembers extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
                        ...
                        <TableRow>
                            ...
                            <CustomTableHeader align="left">
                                ...
                                <i
                                    className="fas fa-sort"
                                    style={{ cursor: 'pointer' }}
                                    onClick={() => this.sortTable('persona')}
                                />
                            </CustomTableHeader>
                            <CustomTableHeader align="left">Location</CustomTableHeader>
                            <CustomTableHeader />
                        </TableRow>
                    </TableHead>
                    <TableBody>
...
export default withSort(ClientMembers);